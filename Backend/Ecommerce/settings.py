...
def cors_preflight_middleware(get_response):
    def middleware(request):
        if request.method == "OPTIONS":
            ...
            response["Access-Control-Allow-Headers"] = "x-platform, Content-Type, Authorization"
            return response
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'catalog.context_processors.catalog_categories',
            ],
        },
    },
]
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media/')  # Updated media root to avoid conflicts
...
# JWT Simple Authentication Settings
